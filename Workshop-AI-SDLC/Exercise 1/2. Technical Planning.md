...
- ✅ Use Spec Kit to analyze GitHub Issues and create full-stack execution plans
- ✅ Define design guardrails using `.github/instructions.md` (frontend + backend)
- ✅ Generate component scaffolding following architectural patterns (UI + API)
- ✅ Scaffold backend cart API endpoints and cart service layer
- ✅ Create implementation milestones and task breakdowns for full-stack features
...
<details>
<summary><h3>STEP 1: Review GitHub Issue from Phase 1</h3></summary>
...
<details>
<summary><h3>STEP 2: Create Design Guardrails Configuration</h3></summary>
...
<details>
<summary><h3>STEP 3: Analyze GitHub Issue with Spec Kit</h3></summary>
...
2. Component dependency tree (CartIcon → CartContext → Header → API)
...
<details>
<summary><h3>STEP 4: Create Component Scaffolding Plan</h3></summary>
...
<details>
<summary><h3>STEP 5: Scaffold CartContext</h3></summary>
...
<details>
<summary><h3>STEP 6: Scaffold CartIcon Component</h3></summary>
...
<details>
<summary><h3>STEP 7: Scaffold Header Integration</h3></summary>
...
<details>
<summary><h3>STEP 8: Create Toast Notification Setup</h3></summary>
...
<details>
<summary><h3>STEP 9: Scaffold Backend Cart API</h3></summary>
...
<details>
<summary><h3>STEP 10: Create Component Documentation</h3></summary>
...
<details>
<summary><h3>STEP 11: Validate Against Design Guardrails</h3></summary>
...
<details>
<summary><h3>STEP 12: Create Implementation Milestones</h3></summary>
...
<details>
<summary><h3>STEP 13: Update GitHub Issue with Technical Plan</h3></summary>
...
```markdown
## 📋 Technical Specification & Scaffolding Complete (Full-Stack)

### Documents Created:
- ✅ Design Guardrails: `.github/instructions.md` (frontend + backend)
...
- ✅ `supply-chain-system/frontend/src/types/cart.ts` - Type definitions for cart
- ✅ `supply-chain-system/frontend/src/context/CartContext.tsx` - Cart state management with localStorage + API integration
- ✅ `supply-chain-system/frontend/src/context/CartContext.test.tsx` - Context test scaffold
- ✅ `supply-chain-system/frontend/src/components/cart/CartIcon.tsx` - Cart icon with badge
- ✅ `supply-chain-system/frontend/src/components/cart/CartIcon.test.tsx` - Icon test scaffold
- ✅ `supply-chain-system/frontend/src/components/cart/README.md` - Component documentation

### Backend API Scaffolded:
- ✅ `supply-chain-system/api/database/migrations/003_add_cart_items.sql` - Cart items table schema
- ✅ `supply-chain-system/api/src/repositories/cartRepository.ts` - Database access layer
- ✅ `supply-chain-system/api/src/services/cartService.ts` - Business logic layer
- ✅ `supply-chain-system/api/src/routes/cart.ts` - API endpoints
- ✅ `supply-chain-system/api/src/repositories/cartRepository.test.ts` - Repository test scaffold
- ✅ `supply-chain-system/api/src/services/cartService.test.ts` - Service test scaffold
- ✅ `supply-chain-system/api/src/routes/cart.test.ts` - API route test scaffold
...
**Backend:**
- ✅ RESTful API design (/api/cart endpoints)
- ✅ Repository pattern for database access
- ✅ Service layer for business logic
- ✅ SQLite migration following existing pattern
...
---
**Phase**: Technical Planning & Scaffolding (Full-Stack) ✅ Complete  
...
<details>
<summary><h3>STEP 14: Commit Scaffolding to Git</h3></summary>
...
<details>
<summary><h3>STEP 15: Verify Scaffolding Structure</h3></summary>
...
- Identify dependencies (Database → API → Context → Icon → Integration)
...
- Tests verify each layer independently (repository → service → routes → context → component)

### **6. Backend Scaffolding Best Practices**
- Layer architecture: Routes → Services → Repositories → Database
...
**Integration & Testing:**
13. Integration testing (frontend → backend → database)

...
![Missing cart icon in header](../../supply-chain-system/frontend/src/assets/initial-nocart.png)
...
![Basic alert notification when adding to cart](../../supply-chain-system/frontend/src/assets/initial-toast-message.png)
*Figure 2: Browser alert popup showing "Added X items to cart" - no visual cart icon or persistent notification*

**Key Problems Identified:**
- ❌ No cart icon visible in header
- ❌ Only basic alert popup for feedback
- ❌ No persistent cart state visualization
- ❌ No way to navigate to cart page
- ❌ Cart data lost on subsequent additions
